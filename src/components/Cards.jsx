...
/* ── 3D tilt card ────────────────────────────────────────────── */
function TiltCard({ card, isMobile, isLeft, isTop }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        position: 'relative',
        cursor: 'default',
        transform: `perspective(700px) rotateX(${tilt.rx}deg) rotateY(${tilt.ry}deg) scale(${tilt.active ? 1.015 : 1})`,
    ...
    >
      ...
      <div style={{
        ...
        background: `radial-gradient(circle at ${tilt.gx}% ${tilt.gy}%, ${card.color}14 0%, transparent 55%)`,
        transition: tilt.active ? 'background 0.06s ease-out' : 'background 0.4s ease-out',
      }} />
      ...
      <motion.div
        ...
        style={{
          ...
          border: `1px solid ${tilt.active ? card.color : 'rgba(255,255,255,0.14)'}`,
          background: tilt.active ? `${card.color}14` : 'rgba(255,255,255,0.02)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          marginBottom: '26px',
          boxShadow: tilt.active ? `0 0 20px ${card.color}30` : 'none',
      ...
      <p style={{
        color: 'rgba(255,255,255,0.43)', fontSize: '0.88rem',
      ...
      <div style={{
        ...
        background: `radial-gradient(circle at 100% 100%, ${card.color}10 0%, transparent 70%)`,
        pointerEvents: 'none',
      }} />
    </div>
  );
